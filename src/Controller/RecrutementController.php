...
class RecrutementController extends AbstractController
{
    ...
    public function apply(
        ...
        $smsService = new SmsService(
            'ACe437f34e4b77f7971f1b55029db46fc5', // SID
            '0bb05ac0f6a8f712ba62105e51c899a4',  // TOKEN
            '+13177432896'                      // FROM
        );

        $userPhone = "+21651039238";
        $message = "Bonjour l'utilisateur " . $user->getName()."a uploader son cv pour le recrutement ".$recrutement->getOffre()->getTitre();
